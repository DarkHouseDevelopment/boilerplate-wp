<?php
add_action( 'gform_after_submission_46', 'send_form_46_to_brightdoor' );
if( !function_exists('send_form_46_to_brightdoor') ){
	function send_form_46_to_brightdoor($entry, $form = NULL){
