<?php
add_action( 'gform_after_submission_18', 'send_form_18_to_brightdoor' );
if( !function_exists('send_form_18_to_brightdoor') ){
	function send_form_18_to_brightdoor($entry, $form = NULL){
