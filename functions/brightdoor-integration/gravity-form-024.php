<?php
add_action( 'gform_after_submission_24', 'send_form_24_to_brightdoor' );
if( !function_exists('send_form_24_to_brightdoor') ){
	function send_form_24_to_brightdoor($entry, $form = NULL){
