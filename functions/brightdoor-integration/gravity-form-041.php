<?php
add_action( 'gform_after_submission_41', 'send_form_41_to_brightdoor' );
if( !function_exists('send_form_41_to_brightdoor') ){
	function send_form_41_to_brightdoor( $entry, $form = NULL ){
