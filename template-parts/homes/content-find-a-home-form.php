		...
		<div class="form-field styled-select">
			...
			<select name="price-min">
				...
				*/ ?>
				...
				<option <?php echo $_SESSION['price-min'] == '535000' ? 'selected="selected"' : ''; ?> value="535000">Mid $500,000s</option>
				<option <?php echo $_SESSION['price-min'] == '570000' ? 'selected="selected"' : ''; ?> value="570000">High $500,000s</option>
				<option <?php echo $_SESSION['price-min'] == '600000' ? 'selected="selected"' : ''; ?> value="600000">$600,000+</option>
			</select>
		</div>
		...
		<div class="form-field styled-select">
			...
			<select name="price-max">
				...
				*/ ?>
				...
				<option <?php echo $_SESSION['price-max'] == '599999' ? 'selected="selected"' : ''; ?> value="599999">High $500,000s</option>
				<option <?php echo $_SESSION['price-max'] == '999999' ? 'selected="selected"' : ''; ?> value="999999">$600,000+</option>
			</select>
		</div>
